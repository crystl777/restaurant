...
public class DishTestData {
    ...
    public static final Dish DISH_1 = new Dish(DISH_ID_1, "Dish 1", 70, LocalDate.now(), RESTAURANT_1);
    public static final Dish DISH_2 = new Dish(DISH_ID_2, "Dish 2", 50, LocalDate.now(), RESTAURANT_1);
